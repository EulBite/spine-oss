...
- **Cross-language test vector integration** - Entry hash and signature verification now tested against shared `test-vectors/vectors.json`
- **RFC 8032 Ed25519 test vectors** - Signature tests use official RFC test vectors for reproducibility

### Changed

- Compatible with `spine-sdk-python` v0.4.0
